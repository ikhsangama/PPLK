...
<div class="container">
  ...
  <h3>Detail Data Lowongan
    ...
    <a class="waves-effect waves-light btn-small green" href="edit_data_lowongan.php">
    ...
    <a class="waves-effect waves-light btn-small red" href="edit_data_lowongan.php">
      <i class="material-icons left">
        clear
      </i>
      Hapus
...
<div class="row">
  ...
  <div class="card col s8">
    <div class="container">
      <h5><?php echo $loker_data['nama'] ?></h5>
